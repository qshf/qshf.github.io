...
> 入口见 [00 全书地图](/books/reinforcement-learning-math/summary/00_book-map/)。
...
## 2. 值迭代 VI vs 策略迭代 PI vs 截断策略迭代 （ch4 + [04_supplement](/books/reinforcement-learning-math/notes/04_supplement-value-iteration-vs-policy-iteration/)）
...
## 6. on-policy vs off-policy （ch7 + [07_supplement](/books/reinforcement-learning-math/notes/07_supplement-on-policy-off-policy/)）
...
## 9. 随机策略梯度 vs 确定性策略梯度 （ch10 10.4 + [supplement](/books/reinforcement-learning-math/notes/10_supplement-policy-gradient-formula-origins/)）
